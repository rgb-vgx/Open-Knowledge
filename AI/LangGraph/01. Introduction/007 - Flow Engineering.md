...
Những luồng này **không chỉ là tuyến tính** — chúng có thể chứa các **decision-making node (nút ra quyết định)** phức tạp, nơi AI sinh ra nhiều đầu ra khác nhau, và những đầu ra đó thường được **đánh giá rồi tinh chỉnh trong một vòng lặp (iterative cycle)**.
